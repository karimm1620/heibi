...
export const id = {
  ...
  goalProgress: {
    screenTitle: "Progres tabungan",
    cardEyebrow: "PROGRES TABUNGAN",
    viewFlow: "Lihat aliran uang",
    openAccessibilityLabel: "Buka progres {{name}}, {{percent}} persen",
    balanceLabel: "Saldo saat ini",
    targetLabel: "Target",
    flowHeading: "Aliran tabungan",
    flowDescription: "Garis menunjukkan saldo berjalan; titik hijau uang masuk dan merah muda uang keluar.",
    flowAccessibilityLabel: "Saldo {{balance}}. Total masuk {{deposits}}. Total keluar {{withdrawals}}.",
    flowInShort: "Masuk",
    flowOutShort: "Keluar",
    progressPercent: "{{percent}}% tercapai",
    depositedLabel: "Total masuk",
    withdrawnLabel: "Total keluar",
    recentHeading: "Transaksi terbaru",
    emptyTitle: "Belum ada aliran uang",
    emptyDescription: "Transaksi pertama akan membentuk garis progres di sini.",
  },
  goalForm: {
  ...
  history: {
    ...
    openGoalAccessibilityLabel: "Buka goal tabungan terkait",
  },
  onboarding: {
