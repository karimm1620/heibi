...
export const en: TranslationDict = {
  ...
  goalProgress: {
    screenTitle: "Savings progress",
    cardEyebrow: "SAVINGS PROGRESS",
    viewFlow: "View money flow",
    openAccessibilityLabel: "Open {{name}} progress, {{percent}} percent",
    balanceLabel: "Current balance",
    targetLabel: "Target",
    flowHeading: "Savings flow",
    flowDescription: "The line shows running balance; green points are money in and pink points are money out.",
    flowAccessibilityLabel: "Balance {{balance}}. Total in {{deposits}}. Total out {{withdrawals}}.",
    flowInShort: "In",
    flowOutShort: "Out",
    progressPercent: "{{percent}}% reached",
    depositedLabel: "Total in",
    withdrawnLabel: "Total out",
    recentHeading: "Recent transactions",
    emptyTitle: "No money flow yet",
    emptyDescription: "Your first transaction will start the progress line here.",
  },
  goalForm: {
  ...
  history: {
    ...
    openGoalAccessibilityLabel: "Open related savings goal",
  },
  onboarding: {
